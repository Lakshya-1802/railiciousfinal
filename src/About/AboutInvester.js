...
import './Aboutinvester.css'
function AboutInvester() {
    
    let message = '"We extend our heartfelt gratitude to our investors for their unwavering support in our journey."'
    return (
        <>
